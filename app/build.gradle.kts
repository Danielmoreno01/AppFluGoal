...
android {
    namespace = "com.example.flugoal"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.flugoal"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Retrofit y Gson para peticiones HTTP y manejo JSON
    implementation("com.squareup.retrofit2:retrofit:2.9.0")
    implementation("com.squareup.retrofit2:converter-gson:2.9.0")
    implementation("com.squareup.okhttp3:okhttp:4.11.0")
    implementation("com.google.code.gson:gson:2.10.1")

    // Corrutinas Kotlin para tareas asincrónicas
    ...
    // Librerías básicas de Android y Jetpack Compose
